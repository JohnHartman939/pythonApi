...
spAccessKeyId = stsResponse['Credentials']['AccessKeyId']
# print('\nAccess Key = ' + spAccessKeyId)
spSecretAccessKey = stsResponse['Credentials']['SecretAccessKey']
# print('\nSecret Access Key = ' + spSecretAccessKey)

spSecurityToken = stsResponse['Credentials']['SessionToken']
# print(stsResponse)
...
amzUserAgent = 'pythonApi/0.0 (Language=Python)'
...
# low to high. Note that there is a trailing \n.
    canonical_headers = 'host:' + host + '\n' + 'user-agent:' + amzUserAgent + '\n' + 'x-amz-access-token:' + accessToken + '\n' + 'x-amz-date:' + amzdate + '\n' + 'x-amz-security-token:' + spSecurityToken + '\n'
...
# Create the signing key using the function defined above.
    signing_key = __getSignatureKey(spSecretAccessKey, datestamp, region, service)
...
# Create authorization header and add to request headers
    authorization_header = algorithm + ' ' + 'Credential=' + spAccessKeyId + '/' + credential_scope + ', ' +  'SignedHeaders=' + signed_headers + ', ' + 'Signature=' + signature
...
# Python note: The 'host' header is added automatically by the Python 'requests' library.
    headers = {'user-agent' : amzUserAgent, 'x-amz-date':amzdate, 'x-amz-access-token': accessToken, 'x-amz-security-token': spSecurityToken, 'Authorization':authorization_header}
